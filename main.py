...
from shoni import CarParkTool

__CHANNEL_USERNAME__ = "SHONI"
__GROUP_USERNAME__   = "SHONI"
...
def banner(console):
    ...
    brand_name = figlet_format('SHONI', font='bloody')
    colors = [
    ...
    print(Colorate.Horizontal(Colors.rainbow, '      𝐂𝐎𝐍𝐓𝐀𝐂𝐓 𝐌𝐄 𝐓𝐎 𝐁𝐔𝐘 𝐔𝐍𝐋𝐈𝐌𝐈𝐓𝐄𝐃 𝐁𝐀𝐋𝐀𝐍𝐂𝐄 𝐓𝐆 @SHONI ')) 
